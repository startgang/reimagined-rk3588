...
Энергопотребление модуля на основе RK3588 в среднем составляет от 6Вт до 15 Вт. Максимальная температура для промышленных устройств может достигать 70°C..85°C. Тип системы охлаждения - это некий компромисс между габаритами и защитой от внешнего влияния среды:
...
Теплоотводящий интерфейс: Термопаста или термопрокладка (с теплопроводностью 3-5 Вт/м·К) для эффективной передачи тепла от чипа к радиатору. Применение теплотрубок диаметром 6мм..8мм будет также эффективно для сложных конструкций. Так, 6мм трубка в среднем отводит порядка 6Вт, следовательно, двух трубок должно хватить на систему с одним процессором. 
